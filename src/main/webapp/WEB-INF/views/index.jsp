...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
      ...
      <script src="lib/angular1.7.0/angular.min.js"></script>
      <script src="<c:url value='/js/app2.js'/>"></script>
      <script src="<c:url value='/js/services2.js'/>"></script>
      <script src="<c:url value='/js/controllers2.js'/>"></script>
  </body>
</html>